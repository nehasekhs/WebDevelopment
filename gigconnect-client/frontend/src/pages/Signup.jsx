...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side */}
      <div className="hidden md:flex w-1/2 bg-gradient-to-br from-indigo-600 to-purple-800 items-center justify-center text-white p-10">
        <div className="max-w-md">
          <h1 className="text-4xl font-extrabold mb-4">Create Your Account 🚀</h1>
          <p className="text-lg text-gray-200">
            Start your journey with us today. Post projects, manage gigs, and
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-gray-950 text-white p-8">
        <div className="w-full max-w-md bg-gray-900/80 backdrop-blur-lg rounded-2xl shadow-lg p-8">
          <h2 className="text-3xl font-extrabold text-center text-indigo-500">Sign Up</h2>
